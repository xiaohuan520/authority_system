...
<div class="layui-layout layui-layout-admin">
	<div class="layui-header">
		...
		<ul class="layui-nav layui-layout-right">
			<li class="layui-nav-item"><a href="javascript:;"> <img src="http://t.cn/RCzsdCq" class="layui-nav-img">${sessionScope.user.nickname}
			</a>
			</li>
			<li class="layui-nav-item"><a href="${ctx}/user/logout">注销</a></li>
		</ul>
	</div>
